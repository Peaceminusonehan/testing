...
const Product =() => {
  ...
  return (
    <Layout>
    <div  className="container mt-4  text-center sh" >
      <h4 className="py-3">Available Bags.Choose your Favourites and Order now!</h4>
      <button className="buttons"  onClick={() => { navigate("/home")}}  type="button" >
                         Back to Home
                    </button>
      <div className="row g-3    d-flex flex-lg-row flex-md-row justify-content-center align-items-center flex-column ">
        {shopdatas}
      </div>
